  ...
  return (
    <section className="flex-1 flex items-center justify-center py-12 px-4 lg:px-10">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
        ...
        >
          <h1 className="text-4xl lg:text-5xl font-extrabold text-[#0f172a] tracking-tight leading-[1.1]">
          ...
          <div className="flex justify-center lg:justify-start">
            <button className="bg-[#00a9f6] text-white font-bold py-3 px-8 rounded-lg shadow-[0_10px_20px_rgba(0,169,246,0.3)] hover:bg-[#0098e0] transition-all hover:-translate-y-0.5 active:translate-y-0">
              Get Started
            </button>
          </div>
        </motion.div>
